...
\label{subsec:seq24_menu_file}
   ...
   The \textbf{File} menu is used to save and load standard MIDI files.  It
...
\end{figure}
   ...
   MIDI track.
   \index{todo!explain formats}
   \textbf{TODO:} Explain the legacy and new formats of the final "track".
...
\end{figure}
   ...
   Apparently groups work with playing screen set only.
