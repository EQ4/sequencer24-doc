...
\label{subsubsec:concepts_terms_measures_ruler}
   ...
   Note:
   \index{bar indicator}
   The original \textsl{Sequencer24} documentation calls this item the
   \textsl{bar indicator}.
...
\label{subsubsec:concepts_terms_screen_set}
   ...
   Patterns panel.
   \textsl{Sequencer24} supports multiple screens sets, and a name can be given to
   each for clarity.
...
\label{subsubsec:concepts_terms_sequence}
   ...
   another synonym for \textsl{pattern}, used in some of the \textsl{Sequencer24}
